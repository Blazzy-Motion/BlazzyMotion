...
namespace BlazzyMotion.Tests.Carousel.SourceGenerator;
...
public abstract class GeneratorTestBase
{
    ...
    protected GeneratorRunResult RunGenerator(string source)
    {
        ...
        // IMPORTANT: Use CarouselAttributes.BzImageAttribute to get the Carousel assembly,
        // as the generator looks for BlazzyMotion.Carousel.Attributes namespace
        var references = new[]
        {
            MetadataReference.CreateFromFile(typeof(object).Assembly.Location),
            MetadataReference.CreateFromFile(typeof(CarouselAttributes.BzImageAttribute).Assembly.Location),
        ...
        var generator = new SourceGen.SourceGen.BzCarouselGenerator();
